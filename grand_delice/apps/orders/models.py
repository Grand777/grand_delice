...
class CompositionColor(models.Model):
    name = models.CharField(max_length=24, blank=True, null=True, default=None)

    def __str__(self):
        return 'Цвет: %s' % self.name
...
class BoxColor(models.Model):
    color = models.CharField(max_length=24, blank=True, null=True, default=None)

    def __str__(self):
        return 'Цвет коробки: %s' % self.color
...
class BoxSize(models.Model):
    size = models.CharField(max_length=24, blank=True, null=True, default=None)

    def __str__(self):
        return 'Размер коробки: %s' % self.size
...
class IndividualComposition(models.Model):
    ...
    box_size = models.ForeignKey(BoxSize, blank=True, null=True, default=None)
    box_color = models.ForeignKey(BoxColor, blank=True, null=True, default=None)
    composition_color = models.ForeignKey(CompositionColor, blank=True, null=True, default=None)
...
class FlowerPreference(models.Model):
    name = models.CharField(max_length=24, blank=True, null=True, default=None)
    individual_composition = models.ForeignKey(IndividualComposition, blank=True, null=True, default=None)
